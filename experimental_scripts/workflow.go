...
func main() {
	...
	balanceTargetDatasets := wf.NewProc("balance_dataset", "python3 ../balance_dataset.py --dbfile=../database --infile={i:unbalanced} --outfile={o:balanced}; echo 'done' > {o:doneflag}")
